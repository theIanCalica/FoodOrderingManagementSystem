Public Class Form1
    ...
    Private Sub btnMsgText_Click(sender As Object, e As EventArgs) Handles btnMsgText.Click
        ...
        '-| For Example:
        Dim result As DialogResult = CustomMessageBox.Show("This is an example of a Text-Only Message Box.")
    ...
    Private Sub btnMsgTextCaption1_Click(sender As Object, e As EventArgs) Handles btnMsgTextCaption1.Click
        labelDialogResult.Text = "Dialog Box Result"
        Dim result As DialogResult = CustomMessageBox.Show("This is an example of a Text + Caption Message Box.",
                                                       "Important Message")
    ...
    Private Sub btnMsgOk_Click(sender As Object, e As EventArgs) Handles btnMsgOk.Click
        labelDialogResult.Text = "Dialog Box Result"
        Dim result = CustomMessageBox.Show("This is an example of an OK Button Message Box.",
                                       "OK Button",
    ...
    Private Sub btnMsgOkCancel_Click(sender As Object, e As EventArgs) Handles btnMsgOkCancel.Click
        labelDialogResult.Text = "Dialog Box Result"
        Dim result = CustomMessageBox.Show("This is an example of an OK, Cancel Button Message Box.",
                                       "OK-Cancel Button",
    ...
    Private Sub btnMsgAbortRetryIgnore_Click(sender As Object, e As EventArgs) Handles btnMsgAbortRetryIgnore.Click
        labelDialogResult.Text = "Dialog Box Result"
        Dim result = CustomMessageBox.Show("This is an example of an Abort, Retry, Ignore Button Message Box.",
    ...
    Private Sub btnMsgYesNo_Click(sender As Object, e As EventArgs) Handles btnMsgYesNo.Click
        labelDialogResult.Text = "Dialog Box Result"
        Dim result = CustomMessageBox.Show("This is an example of an Yes, No Button Message Box.",
                                       "Yes-No Button",
    ...
    Private Sub btnMsgYesNoCancel_Click(sender As Object, e As EventArgs) Handles btnMsgYesNoCancel.Click
        labelDialogResult.Text = "Dialog Box Result"
        Dim result = CustomMessageBox.Show("This is an example of an Yes, No, Cancel Button Message Box.",
    ...
    Private Sub btnMsgRetryCancel_Click(sender As Object, e As EventArgs) Handles btnMsgRetryCancel.Click
        labelDialogResult.Text = "Dialog Box Result"
        Dim result = CustomMessageBox.Show("This is an example of an Retry, Cancel Button Message Box.",
                                       "Retry-Cancel Button",
    ...
    Private Sub btnMsgQuestion_Click(sender As Object, e As EventArgs) Handles btnMsgQuestion.Click
        labelDialogResult.Text = "Dialog Box Result"
        Dim result = CustomMessageBox.Show("This is an example of an Question Icon Message Box.",
                                       "Question Icon",
                                       MessageBoxButtons.OKCancel,
    ...
    Private Sub btnMsgWarning_Click(sender As Object, e As EventArgs) Handles btnMsgWarning.Click
        labelDialogResult.Text = "Dialog Box Result"
        Dim result = CustomMessageBox.Show("This is an example of an Warning-Exclamation Icon Message Box.",
    ...
    Private Sub btnMsgError_Click(sender As Object, e As EventArgs) Handles btnMsgError.Click
        labelDialogResult.Text = "Dialog Box Result"
        Dim result = CustomMessageBox.Show("This is an example of an Error-Stop Icon Message Box.",
                                       "Error-Stop Icon",
                                       MessageBoxButtons.RetryCancel,
    ...
    Private Sub btnMsgInformation_Click(sender As Object, e As EventArgs) Handles btnMsgInformation.Click
        labelDialogResult.Text = "Dialog Box Result"
        Dim result = CustomMessageBox.Show("This is an example of an Information Icon Message Box.",
                                       "Information Icon",
                                       MessageBoxButtons.OK,
    ...
    Private Sub btnMsgButton1_Click(sender As Object, e As EventArgs) Handles btnMsgButton1.Click
        labelDialogResult.Text = "Dialog Box Result"
        Dim result = CustomMessageBox.Show("This is an example of a Message Box that sets Button1 as the Default Selected Button." & vbLf & "That is, pressing the Enter Key selects the Button1.",
                                       "Warning-Exclamation Icon",
                                       MessageBoxButtons.YesNoCancel,
                                       MessageBoxIcon.Warning,
    ...
    Private Sub btnMsgButton2_Click(sender As Object, e As EventArgs) Handles btnMsgButton2.Click
        labelDialogResult.Text = "Dialog Box Result"
        Dim result = CustomMessageBox.Show("This is an example of a Message Box that sets Button2 as the Default Selected Button." & vbLf & "That is, pressing the Enter Key selects the Button2.",
                                       "Warning-Exclamation Icon",
                                       MessageBoxButtons.RetryCancel,
                                       MessageBoxIcon.Information,
    ...
    Private Sub btnMsgButton3_Click(sender As Object, e As EventArgs) Handles btnMsgButton3.Click
        labelDialogResult.Text = "Dialog Box Result"
        Dim result = CustomMessageBox.Show("This is an example of a Message Box that sets Button3 as the Default Selected Button." & vbLf & "That is, pressing the Enter Key selects the Button3.",
                                       "Warning-Exclamation Icon",
                                       MessageBoxButtons.AbortRetryIgnore,
                                       MessageBoxIcon.[Error],
    ...
    Private Sub Any()
        ...
        CustomMessageBox.Show(Me, "Text")
        CustomMessageBox.Show(Me, "Text", "Caption")
        CustomMessageBox.Show(Me, "Text", "Caption", MessageBoxButtons.OKCancel)
        'Etc
    End Sub
End Class
