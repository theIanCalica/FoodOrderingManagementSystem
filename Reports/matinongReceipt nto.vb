...
Public Class matinongReceipt_nto
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "matinongReceipt nto.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "foodOrdeing_managementSystem.matinongReceipt nto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedmatinongReceipt_nto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As matinongReceipt_nto = New matinongReceipt_nto()
        rpt.Site = Me.Site
        Return rpt
    End Function
